...
3. Configura:
   ...
   - **Argumentos**: `-ExecutionPolicy Bypass -File "C:\Users\zelda\Documents\ESTUDIO PROGRAMACION\RULES\.cursor\commands\switch-theme.ps1"`
...
```powershell
& "C:\Users\zelda\Documents\ESTUDIO PROGRAMACION\RULES\.cursor\commands\switch-theme.ps1"
```
